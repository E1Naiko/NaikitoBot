"""Extensiones de comandos de Discord para NaikitoBot.

Cada subpaquete es una extensión cargada por ``core.bot.NaikitoBot.setup_hook``
mediante ``bot.load_extension()``:
