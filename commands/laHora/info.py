"""Consultas de laHora: estadísticas, ranking y ayuda."""

import discord
from discord import app_commands

from commands.laHora.base import solo_servidor
...
class InfoMixin:
    """Comandos de consulta del ranking de decir la hora a la hora."""

    @app_commands.command(
        name="laHora_stats",
        description="Muestra tus estadísticas de laHora.",
    )
    async def stats(
        self,
        interaction: discord.Interaction,
    ):
        """Muestra las estadísticas de laHora."""
    ...
    @app_commands.command(
        name="laHora_top",
        description="Muestra el TOP de laHora del servidor.",
    )
    async def top(
        self,
        interaction: discord.Interaction,
    ...
    @app_commands.command(
        name="laHora_ayuda",
        description="Muestra los comandos de laHora.",
    )
    async def ayuda(
        self,
        interaction: discord.Interaction,
