"""Módulo del sistema Madrugue de NaikitoBot.

Recompensa a los usuarios que están activos en el servidor durante la
madrugada, entregando puntos canjeables por recompensas. Las horas de bonus y
los valores de puntos se configuran desde ``.env``.
